...
public class CalculaScoreComIdade implements CalculaScore{
    ...
    public void calcula(Partida partida) {
        ...
        partida.setScore((((partida.getQuantidadeMaximaErrosDificuldade()-partida.getQuantidadeErros())*(partida.getIdadeJogador()+1))*1000) + (partida.getScore()/(partida.diferencaTempo()+1)) - (partida.getDicas()*100));
