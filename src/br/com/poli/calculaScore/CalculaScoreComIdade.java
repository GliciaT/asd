...
public class CalculaScoreComIdade implements CalculaScore{
    ...
    public void calcula(Partida partida) {
        ...
        partida.setScore((((partida.getQuantidadeMaximaErrosDificuldade()-partida.getQuantidadeErros())/partida.diferencaTempo())*1000) + (partida.getScore()/partida.getIdadeJogador()));
